...
switch _mode do {
	...
	case "onLoad": {
		...
		//Hide vehicle notification displayed next to action menu.
	...
	case "onUnload": {
		//Reset the DLC info displayed in RscDisplayLoading
		uinamespace setvariable ["BIS_RscDisplayLoading_SelectedDLCAppId", 0];
	};
};