...
switch _mode do
{
	case "onLoad":
	{
		...
		_ctrlMap ctrladdeventhandler ["mousemoving","with uinamespace do {['mousemoving',_this,'RscDisplayArcadeMap_Layout_6'] call RscDisplayArcadeMap_Layout_6_script};"];

		_ctrlToolbox = _display displayctrl 104;
		_ctrlToolbox ctrladdeventhandler ["ToolBoxSelChanged","with uinamespace do {['ToolBoxSelChanged', [ctrlparent (_this select 0), _this select 1], 'RscDisplayArcadeMap_Layout_6'] call RscDisplayArcadeMap_Layout_6_script};"];
		['ToolBoxSelChanged', [_display, 0], 'RscDisplayArcadeMap_Layout_6'] call RscDisplayArcadeMap_Layout_6_script;
		...
		_display displayaddeventhandler ["keydown","with uinamespace do {['KeyDown',_this,'RscDisplayArcadeMap_Layout_6'] call RscDisplayArcadeMap_Layout_6_script};"];
	...
	case "KeyDown":
	{
		...
		#define TOOLBOX_CHANGE(ID)	['ToolBoxSelChanged', [_display, ID], 'RscDisplayArcadeMap_Layout_6'] call RscDisplayArcadeMap_Layout_6_script;
