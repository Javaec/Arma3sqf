...
switch _mode do
{
	case "onLoad":
	{
		...
		//Show main Welcome Screen, Helicopters DLC, or trial?		
		if ((configName (configFile >> "CfgPatches" >> "A3_Missions_F_EPC")) != "") then 
		{
			...
			{
				//Helicopters DLC version
				//Register for the session.
				uiNamespace setVariable ["BIS_welcomeScreenHelicoptersShown", true];
				...
				_message = "";
				_message = _message + "<t align='center' size='8' shadow='0'><img image='A3\Data_F_Heli\Logos\arma3_heli_icon_ca' /></t><br />";
				_message = _message + (format [localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARA", _colorHighlight]) + "<br /><br />";
				
				_message = _message + "<t align='center' size='8' shadow='0'><img image='A3\Data_F_Heli\Images\heli_popupImage_01_ca' /></t><br /><br />";
				
				_message = _message + "<t color='" + _colorHighlight + "'>" + (toUpper (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARB_TITLE")) + "</t><br />";			
				_message = _message + (format [localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARB", _colorHighlight, _colorWarning, "http://arma3.com/dlc/karts", "http://www.bistudio.com/company/developers-blog/465-roadmap-14-15-dlc-strategy-blog"]) + "<br /><br />";
				_message = _message + "<a href='http://helicopters.arma3.com/' color='" + _colorWarning + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARB_FOOTER") + "</a><br /><br />";
				
				_message = _message + "<t align='center' size='8' shadow='0'><img image='A3\Data_F_Heli\Images\heli_popupImage_02_ca' /></t><br /><br />";
				
				_message = _message + "<t color='" + _colorHighlight + "'>" + (toUpper (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARC_TITLE")) + "</t><br />";
				_message = _message + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARC") + "<br /><br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARC_LIST1_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARC_LIST1") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARC_LIST2_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARC_LIST2") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARC_LIST3_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARC_LIST3") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARC_LIST4_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARC_LIST4") + "<br /><br />";
				
				_message = _message + "<t align='center' size='8' shadow='0'><img image='A3\Data_F_Heli\Images\heli_popupImage_03_ca' /></t><br /><br />";
				
				_message = _message + "<t color='" + _colorHighlight + "'>" + (toUpper (localize "STR_A3_RSCDISPLAYWELCOME_EPA_PARD_TITLE")) + "</t><br />";
				_message = _message + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD") + "<br /><br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST1_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST1") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST2_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST2") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST3_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST3") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST7_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST7") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST8_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST8") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST9_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST9") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST10_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST10") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST4_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST4") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST5_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST5") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST6_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST6") + "<br />";
				_message = _message + _bullet + " <t color='" + _colorHighlight + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST11_TITLE") + "</t> - " + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_LIST11") + "<br /><br />";
				
				_message = _message + "<a href='http://www.arma3.com/whatsnewhelicopters/' color='" + _colorWarning + "'>" + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_FOOTER") + "</a><br /><br />";
				
				_message = _message + (localize "STR_A3_RSCDISPLAYWELCOME_HELI_PARD_FOOTER2") + "<br />";
