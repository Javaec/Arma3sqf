...
switch _mode do
{
	case "onLoad":
	{
		...
		_ctrlMap ctrladdeventhandler ["mousemoving","with uinamespace do {['mousemoving',_this,'RscDisplayArcadeMap_Layout_2'] call RscDisplayArcadeMap_Layout_2_script};"];

		_ctrlToolbox = _display displayctrl 104;
		_ctrlToolbox ctrladdeventhandler ["ToolBoxSelChanged","with uinamespace do {['ToolBoxSelChanged', [ctrlparent (_this select 0), _this select 1], 'RscDisplayArcadeMap_Layout_2'] call RscDisplayArcadeMap_Layout_2_script};"];
		['ToolBoxSelChanged', [_display, 0], 'RscDisplayArcadeMap_Layout_2'] call RscDisplayArcadeMap_Layout_2_script;
		...
		_control ctrladdeventhandler ["buttonclick","with uinamespace do {['HideButtonClicked',_this,'RscDisplayArcadeMap_Layout_2'] call RscDisplayArcadeMap_Layout_2_script};"];

		//Register event-handler for Textures button. Pass _display as a parameter.
		_control = _display displayctrl 112;
		_control ctrladdeventhandler ["buttonclick","with uinamespace do {['TexturesButtonClicked',_this,'RscDisplayArcadeMap_Layout_2'] call RscDisplayArcadeMap_Layout_2_script};"];

		//IDs event-handler for IDs button. Pass _display as a parameter.
		_control = _display displayctrl 111;
		_control ctrladdeventhandler ["buttonclick","with uinamespace do {['IDsButtonClicked',_this,'RscDisplayArcadeMap_Layout_2'] call RscDisplayArcadeMap_Layout_2_script};"];
		...
		_display displayaddeventhandler ["keydown","with uinamespace do {['KeyDown',_this,'RscDisplayArcadeMap_Layout_2'] call RscDisplayArcadeMap_Layout_2_script};"];
	...
	{
		_ctrlHide = _params select 0;
		_display = ctrlParent _ctrlHide;
	...
	case "TexturesButtonClicked":
	{
		_texturesIcon = _params select 0;
		_display = ctrlParent _texturesIcon;
	...
	//--- IDs button clicked
	case "IDsButtonClicked":
	{
		_idIcon = _params select 0;
		_display = ctrlParent _idIcon;
	...
	case "KeyDown":
	{
		...
		#define TOOLBOX_CHANGE(ID)	['ToolBoxSelChanged', [_display, ID], 'RscDisplayArcadeMap_Layout_2'] call RscDisplayArcadeMap_Layout_2_script;
