...
if (true) then
{
	...
	_this setVehicleVarName "BIS_AthiraTableNotebook";
	BIS_AthiraTableNotebook = _this;
...
if (true) then
{
	...
	_vehicle_390 = _this;
	_this setVehicleVarName "BIS_AthiraTableFiles";
	BIS_AthiraTableFiles = _this;
...
if (true) then
{
	...
	_vehicle_392 = _this;
	_this setVehicleVarName "BIS_AthiraTablePhone";
	BIS_AthiraTablePhone = _this;
