BIS_player createDiaryRecord [
	...
	[
		...
		localize "str_a3_showcase_faction_blufor_mission"
	]
];
...
BIS_player createDiaryRecord [
	...
	[
		...
		"<img image = 'a3\missions_f_gamma\data\img\Faction_BLUFOR_briefing_CA.paa' width = '370' align='center'/>" + localize "STR_A3_Showcase_Showcase_Faction_BLUFOR_Summary_text"
	]
]; 
