...
BIS_fnc_credits_movie_script = [_displayMain,_mode] spawn {
	...
	if (_mode > 0) then {
		...
		with uinamespace do {
			...
			//----- Basic Variables ------
			_backColor = [0.1,0.1,0.1,1];		//background color
			...
			*/
			...
			_ctrlLogoA ctrlsettext "\A3\Ui_f\data\logos\arma3_splash_ca.paa";
			_ctrlLogoA ctrlsettextcolor [1,1,1,1];
			_ctrlLogoA_W = 0.5 * safezoneW;
			_ctrlLogoA_H = 0.5 * safezoneH;
